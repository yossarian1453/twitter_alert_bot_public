...
for i in range (len(user_name)):
    ...
    command = f'curl "https://api.twitter.com/2/users/by/username/{last_portion}" -H "Authorization: Bearer AAAAAAAAAAAAAAAAAAAAAE2cMgEAAAAA%2F09FeHOkK5mqers%2Fa32RLBOVkVk%3DFza0CBgM4qKFx81HDe28W6dJUHaimXCESmqYFEtmx2lRvtRfYK"'
